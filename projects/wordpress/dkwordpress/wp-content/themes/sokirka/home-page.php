			...
			<div class="slider">
				  ...
				  <div class="carousel-inner" role="listbox">
					<div class="item active">
						<div class="wrap_caption">
						  <div class="caption_carousel">
							<h1><?php echo $redux_demo["homepage-h1_first"]; ?></h1>
							<p><?php echo $redux_demo["homepage-p_first"]; ?></p>
						  </div>						
						</div>
					</div>					
					<div class="item">
						<div class="wrap_caption">
						  <div class="caption_carousel">
							<h1><?php echo $redux_demo["homepage-h1_second"]; ?></h1>
							<p><?php echo $redux_demo["homepage-p_first"]; ?></p>
						  </div>						
						</div>
					</div>					
					<div class="item ">
						<div class="wrap_caption">
						  <div class="caption_carousel">
							<h1><?php echo $redux_demo["homepage-h1_third"]; ?></h1>
							<p><?php echo $redux_demo["homepage-p_first"]; ?></p>
						  </div>						
						</div>
					</div>			
