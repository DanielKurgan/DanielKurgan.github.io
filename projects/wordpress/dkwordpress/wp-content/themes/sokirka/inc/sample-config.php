<?php
     ...
     */
    // Header settings
    // HERE YOU CAN CHANGE LOGO IN HEADER
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Header settings', 'sokirka' ),
        'id'               => 'header-settings',
        'desc'             => __( 'Here you can control header:)', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-arrow-up'
    ) );
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Изменение логотипа', 'redux-framework-demo' ),
        'id'         => 'dk-logo_change',
        ...
        'fields'     => array(
            array(
                ...
                'desc'     => __( 'Здесь можно поменять логотип', 'redux-framework-demo' ),
                'subtitle' => __( 'Здесь можно загрузить картинку либо вставить ссылку на неё', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'         => 'home-page',
        'desc'       => __( 'Здесь вы можете изменить элементы главной страницы', 'redux-framework-demo' ),
        'subsection' => true,
        'fields'     => array(
            array(
                'id'       => 'homepage-h1_first',
                'type'     => 'text',
            ...
            array(
                'id'       => 'homepage-p_first',
                'type'     => 'text',
                'title'    => __( 'Первый подзаголовок', 'redux-framework-demo' ),
                'subtitle' => __( 'Subtitle', 'redux-framework-demo' ),
                'desc'     => __( 'Field Description', 'redux-framework-demo' ),
                'default'  => 'Default Text',
            ),
            array(
                'id'       => 'homepage-h1_second',
                'type'     => 'text',
                'title'    => __( 'Второй заголовок', 'redux-framework-demo' ),
                'subtitle' => __( 'Subtitle', 'redux-framework-demo' ),
                'desc'     => __( 'Field Description', 'redux-framework-demo' ),
                'default'  => 'Default Text',
            ),
            array(
                'id'       => 'homepage-p_second',
                'type'     => 'text',
                'title'    => __( 'Второй подзаголовок', 'redux-framework-demo' ),
                'subtitle' => __( 'Subtitle', 'redux-framework-demo' ),
                'desc'     => __( 'Field Description', 'redux-framework-demo' ),
                'default'  => 'Default Text',
            ),
            array(
                'id'       => 'homepage-h1_third',
                'type'     => 'text',
                'title'    => __( 'Третий заголовок', 'redux-framework-demo' ),
                'subtitle' => __( 'Subtitle', 'redux-framework-demo' ),
                'desc'     => __( 'Field Description', 'redux-framework-demo' ),
                'default'  => 'Default Text',
            ),
            array(
                'id'       => 'homepage-p_third',
                'type'     => 'text',
                'title'    => __( 'Третий подзаголовок', 'redux-framework-demo' ),
                'subtitle' => __( 'Subtitle', 'redux-framework-demo' ),
                'desc'     => __( 'Field Description', 'redux-framework-demo' ),
                'default'  => 'Default Text',
            ),
